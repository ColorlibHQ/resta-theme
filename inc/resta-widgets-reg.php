...
function resta_widgets_init() {
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Footer One', 'resta' ),
        'id'            => 'footer-1',
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Footer Two', 'resta' ),
        'id'            => 'footer-2',
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Footer Three', 'resta' ),
        'id'            => 'footer-3',
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Footer Four', 'resta' ),
        'id'            => 'footer-4',

...
// image default alt
if ( ! function_exists( 'resta_img_default_alt' ) ) {
	function resta_img_default_alt( $url = '' ) {
...
// Image Tag
if ( ! function_exists( 'resta_img_tag' ) ) {
	function resta_img_tag( array $args ) {
...
// Anchor Tag
if ( ! function_exists( 'resta_anchor_tag' ) ) {
	function resta_anchor_tag( array $args ) {
...
// Heading Tag
if ( ! function_exists( 'resta_heading_tag' ) ) {
	function resta_heading_tag( array $args ) {
...
// Paragraph Tag
if ( ! function_exists( 'resta_paragraph_tag' ) ) {
	function resta_paragraph_tag( array $args ) {
...
// Other Tag
if ( ! function_exists( 'resta_other_tag' ) ) {
	function resta_other_tag( array $args ) {
...
// Button Element 
if ( ! function_exists( 'resta_button_element ' ) ) {
	function resta_button_element( array $args ) {

 ...
 */
	...
	class resta_Enqueue{
		...
		public function resta_scripts_enqueue_init(){
			add_action( 'wp_enqueue_scripts', array( $this, 'resta_frontend_enqueue_scripts', ) );
		}

		public function resta_frontend_enqueue_scripts( ){

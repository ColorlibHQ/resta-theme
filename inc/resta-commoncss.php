...
// enqueue css
function resta_common_custom_css(){
    
    wp_enqueue_style( 'resta-common', get_template_directory_uri().'/assets/css/common.css' );

		$whiteColor     		  	= '#ffffff';
		$themeColor     		  	= resta_opt( 'resta_theme_color' ) != '#131313' ? resta_opt( 'resta_theme_color' ) : '';
		$themeSecColor     		  	= '';
		$bookBtnColor       		= resta_opt( 'resta_book_btn_color' ) != '#131313' ? resta_opt('resta_book_btn_color') : '';
		$bookBtnHoverBgColor     	= resta_opt( 'resta_book_btn_hvr_bg_color' ) != '#131313' ? resta_opt('resta_book_btn_hvr_bg_color') : $themeColor;
		$hoverColor     	  	  = resta_opt( 'resta_quote_btn_hvr_text_color');

		$headerTop_bg     		  = '';
		$navbarBgColor     		  = resta_opt( 'resta_navbar_bg_color' ) != '#082b49' ? resta_opt( 'resta_navbar_bg_color') : '';
		$headerTop_col     		  = resta_opt( 'resta_top_header_color' );

		$headerTopBg      		  = resta_opt( 'resta_top_header_bg_color');
		$headerBg          		  = resta_opt( 'resta_header_bg_color') != '#ffffff' ? resta_opt( 'resta_header_bg_color') : '';
		$menuColor          	  = resta_opt( 'resta_header_menu_color' ) != '#131313' ? resta_opt('resta_header_menu_color') : '';
		$menuHoverColor           = resta_opt( 'resta_header_menu_hover_color' ) != '#808080' ? resta_opt('resta_header_menu_hover_color') : $themeColor;
		$menuFixedHoverColor      = resta_opt( 'resta_header_menu_fixed_hover_color' );
		$dropMenuBgColor          = resta_opt( 'resta_header_drop_menu_bg_color' ) != '#ffffff' ? resta_opt('resta_header_drop_menu_bg_color') : $themeColor;
		$dropMenuColor            = resta_opt( 'resta_dropdown_menu_color' ) != '#131313' ? resta_opt('resta_dropdown_menu_color') : '';
		$dropMenuHovColor         = resta_opt( 'resta_dropdown_menu_hover_color' ) != '#808080' ? resta_opt('resta_dropdown_menu_hover_color') : $themeColor;

		$footerwbgColor     	  = resta_opt( 'resta_footer_widget_bg_color' );
		$footerwHeadColor   	  = resta_opt('resta_footer_widget_heading_color');
		$footerwTextColor   	  = resta_opt('resta_footer_widget_text_color');
		$footerwanchorcolor 	  = resta_opt('resta_footer_widget_anchor_color') != '#ffffff' ? resta_opt('resta_footer_widget_anchor_color') : '';
		$footerwanchorhovcolor    = resta_opt('resta_footer_widget_anchor_hover_color') != '#ffffff' ? resta_opt('resta_footer_widget_anchor_hover_color') : '';
		
		$fofbg					  = resta_opt('resta_fof_bg_color');
		$foftonecolor			  = resta_opt('resta_fof_textone_color');
		$fofttwocolor			  = resta_opt('resta_fof_texttwo_color');

		$bannerBtnHeaderSpanColor = $themeColor != '#ff5e13' ? $themeColor : '';
		$footerAncDefColor 		  = resta_opt('resta_footer_widget_anchor_color') != '#9e9e9e' ? resta_opt('resta_footer_widget_anchor_color') : '';
		...
		$customcss ="			
			...
			.footer-area .single-footer-widget .btn, .footer .footer_top .footer_widget .resta_mailchimp_newsletter_widget button, .footer .footer_top .footer_widget .resta_mailchimp_newsletter_widget button
			{
    ...
    wp_add_inline_style( 'resta-common', $customcss );
    
}
add_action( 'wp_enqueue_scripts', 'resta_common_custom_css', 50 );